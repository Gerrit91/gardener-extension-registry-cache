...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RegistryMirror)(nil), (*registry.RegistryMirror)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_RegistryMirror_To_registry_RegistryMirror(a.(*RegistryMirror), b.(*registry.RegistryMirror), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*registry.RegistryMirror)(nil), (*RegistryMirror)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_registry_RegistryMirror_To_v1alpha1_RegistryMirror(a.(*registry.RegistryMirror), b.(*RegistryMirror), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_RegistryConfig_To_registry_RegistryConfig(in *RegistryConfig, out *registry.RegistryConfig, s conversion.Scope) error {
	out.Mirrors = *(*[]registry.RegistryMirror)(unsafe.Pointer(&in.Mirrors))
	return nil
}
...
// Convert_v1alpha1_RegistryMirror_To_registry_RegistryMirror is an autogenerated conversion function.
func Convert_v1alpha1_RegistryMirror_To_registry_RegistryMirror(in *RegistryMirror, out *registry.RegistryMirror, s conversion.Scope) error {
	return autoConvert_v1alpha1_RegistryMirror_To_registry_RegistryMirror(in, out, s)
}
...
// Convert_registry_RegistryMirror_To_v1alpha1_RegistryMirror is an autogenerated conversion function.
func Convert_registry_RegistryMirror_To_v1alpha1_RegistryMirror(in *registry.RegistryMirror, out *RegistryMirror, s conversion.Scope) error {
	return autoConvert_registry_RegistryMirror_To_v1alpha1_RegistryMirror(in, out, s)
}
